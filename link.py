...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_display)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.line_display)
        self.label_open = QtWidgets.QLabel(Dialog)
        self.label_open.setObjectName("label_open")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_open)
        self.combo_open_in = QtWidgets.QComboBox(Dialog)
        self.combo_open_in.setObjectName("combo_open_in")
        self.combo_open_in.addItem("")
        self.combo_open_in.addItem("")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.combo_open_in)
        self.label_search = QtWidgets.QLabel(Dialog)
        self.label_search.setObjectName("label_search")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_search)
        ...
        self.combo_search_type.addItem("")
        self.combo_search_type.addItem("")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.combo_search_type)
        self.line_search = QtWidgets.QLineEdit(Dialog)
        self.line_search.setObjectName("line_search")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.line_search)
        self.button_current = QtWidgets.QPushButton(Dialog)
        self.button_current.setObjectName("button_current")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.button_current)
