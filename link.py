...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(
            1, QtWidgets.QFormLayout.LabelRole, self.label_display)
        ...
        self.combo_search_type.addItem("")
        self.formLayout.setWidget(
            3, QtWidgets.QFormLayout.FieldRole, self.combo_search_type)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.combo_search_type.setItemText(
            2, _translate("Dialog", "Search query"))
